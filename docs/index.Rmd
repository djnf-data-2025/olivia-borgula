...
Olivia Borgula [oborgula\@terpmail.umd.edu](mailto:oborgula@terpmail.umd.edu){.email} \| 616-970-3620 June 2, 2025
...
#rsw comment: great. now let's get some graphics and a leaflet map on here with an interactive tooltip (or a datawrapper map) to illustrate the cotton t shirt trade.
