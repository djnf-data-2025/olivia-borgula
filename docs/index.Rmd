...
china_x2025 <- read_csv("../data/country_data/china_x2025.csv")%>%clean_names()  
nicaragua_x2025 <- read_csv("../data/country_data/nicaragua_x2025.csv")%>%clean_names()
bangladesh_x2025 <- read_csv("../data/country_data/bangladesh_x2025.csv")%>%clean_names()
honduras_x2025 <- read_csv("../data/country_data/honduras_x2025.csv")%>%clean_names()
india_x2025 <- read_csv("../data/country_data/india_x2025.csv")%>%clean_names()
vietnam_x2025 <- read_csv("../data/country_data/vietnam_x2025.csv")%>%clean_names()
...
total_x2020_x2025 <- x2020_x2025_imports%>%
...
x2024_x2025 <- x2020_x2025_imports %>%
  mutate(
  ...
  summarize(monthly_total = sum(quantity, na.rm = TRUE), .groups = "drop")

write_csv(x2024_x2025, "quantity_monthly.csv")
```

<pre><code class="r">
```{r, results='asis', echo=FALSE}
cat('<div class="flourish-embed flourish-chart" data-src="visualisation/23591396"> <script src="https://public.flourish.studio/resources/embed.js"></script>
<noscript><img src="https://public.flourish.studio/visualisation/23591396/thumbnail" width="75%" alt="chart visualization" /></noscript>

</div>') 
```


### 2020 to 2025 data - Monetary 

```{r}
value_x2020_x2025 <- x2020_x2025_imports%>%
  group_by(country, year)%>%
...
value_monthly <- x2020_x2025_imports %>%
  mutate(
    year = as.integer(year),
    month = as.integer(month),
    year_month = as.Date(sprintf("%04d-%02d-01", year, month))  # e.g., "2025-01-01"
...
write_csv(value_monthly, "value_monthly.csv")

```


### T-shirts as a promotional product data 
